...
autocmd("LspAttach", {
	...
	callback = function(event)
		...
		vim.keymap.set({ "i", "n" }, "<C-s>", vim.lsp.buf.signature_help, { desc = "Signature Documentation" })
...
cmd("LspStatus", lsp_status, { desc = "Show detailed LSP status" })
...
cmd("LspCapabilities", check_lsp_capabilities, { desc = "Show LSP capabilities" })
...
cmd("LspDiagnostics", lsp_diagnostics_info, { desc = "Show LSP diagnostics count" })
...
-- Create command
cmd("LspInfo", lsp_info, { desc = "Show comprehensive LSP information" })
