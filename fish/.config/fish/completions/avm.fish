...
complete -c avm -n "__fish_avm_using_subcommand help; and not __fish_seen_subcommand_from use install uninstall list updatecompletions help" -f -a "use" -d 'Use a specific version of Anchor'
complete -c avm -n "__fish_avm_using_subcommand help; and not __fish_seen_subcommand_from use install uninstall list updatecompletions help" -f -a "install" -d 'Install a version of Anchor'
complete -c avm -n "__fish_avm_using_subcommand help; and not __fish_seen_subcommand_from use install uninstall list updatecompletions help" -f -a "uninstall" -d 'Uninstall a version of Anchor'
complete -c avm -n "__fish_avm_using_subcommand help; and not __fish_seen_subcommand_from use install uninstall list updatecompletions help" -f -a "list" -d 'List available versions of Anchor'
complete -c avm -n "__fish_avm_using_subcommand help; and not __fish_seen_subcommand_from use install uninstall list updatecompletions help" -f -a "update" -d 'Update to the latest Anchor version'
complete -c avm -n "__fish_avm_using_subcommand help; and not __fish_seen_subcommand_from use install uninstall list updatecompletions help" -f -a "completions" -d 'Generate shell completions for AVM'
complete -c avm -n "__fish_avm_using_subcommand help; and not __fish_seen_subcommand_from use install uninstall list updatecompletions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
