...
```bash
# Global (recommended for personal skills)
...
- **compatibility**: Set to `opencode` for OpenCode-specific skills
...
- [ ] `description` is specific and 1-1024 chars
...
1. **Restart OpenCode** (if running) to load the Skill
...
3. **Verify activation**: OpenCode should use the Skill automatically

4. **Check behavior**: Confirm OpenCode follows the instructions correctly
...
4. **Check permissions**: Skills can be restricted via `opencode.json`
...
9. **Add compatibility field**: Use `compatibility: opencode` for OpenCode-specific skills
...
- [ ] Skill activates on relevant queries
- [ ] OpenCode follows instructions correctly
