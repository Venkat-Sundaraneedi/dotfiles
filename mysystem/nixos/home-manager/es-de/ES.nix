...
in
  pkgs.appimageTools.wrapType2 {
    ...
    extraBwrapArgs = [
      "--bind-try /home/greed/.config/retro/ROMs /home/greed/.config/retro/ROMs" # Your update
      # Remove "--bind-try /etc/nixos/ /etc/nixos/" if not needed (ES-DE unlikely requires Nix config access)
    ];
    dieWithParent = false;
    meta = {
